				...
				<td>
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td>
								<form
									action="${pageContext.request.contextPath}/UserServlet?method=updateUser&id=${loginuser.id}"
									method="post">
									...
									<table width="100%" border="0" cellspacing="2" class="upline">
										...
										<tr>
											...
											<td><input type="password" name="password"
												class="textinput" id="password"/></td>
										...
										<tr>
											...
											<td colspan="2"><input name="telephone" type="text"
												value="${loginuser.phone}" class="textinput" id="phone"/>
												<span id="ph"></span>
												</td>
										</tr>
									...
									<p style="text-align: center">
										...
										<input type="image" src="images/botton_gif_025.gif" border="0"
											id="tijiao"  onclick="check(this.form)">
